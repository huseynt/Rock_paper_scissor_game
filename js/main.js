...
function calculateScore(player1, player2) {
    ...
    if (player1 === player2) {
        ...
        if (Number(player1Score.textContent)==9) {
            console.log("heey")
        ...
        if (Number(player2Score.textContent)==9) {
            console.log("bottt")
...
const playerCongratule = document.querySelector("#playerCongratule")
const playerCongratuleItem = document.querySelector("#playerCongratuleItem")
const playerCongratuleItemGame = document.querySelector("#playerCongratuleItemGame")

function congrate(player) {
    playerCongratuleItem.textContent=`${player} is winner !!!`
    playerCongratule.style.display="grid"
    reset()
}
playerCongratuleItemGame.addEventListener("click", function () {
    playerCongratule.style.display="none"
})
